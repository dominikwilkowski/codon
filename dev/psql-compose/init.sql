...
INSERT INTO equipment_notes (equipment, person, notes, media1, media2, media3) VALUES
(1, 2, E'The thing still refuses to make coffee.', NULL, NULL, NULL),
(1, 3, E'Found a sandwich from 2019 inside the item.', NULL, NULL, NULL),
(1, 1, E'Do not press the red button unless you enjoy alarms.', NULL, NULL, NULL),
(1, 2, E'Equipment refuses to operate until it gets a motivational speech.', 'public/upload_media/F-1/57d6ba05-b674-4df2-82b0-caab939726ae.jpg', NULL, NULL),
(3, 4, E'Dust levels exceeded recommended safe limits—again.', NULL, NULL, NULL),
(3, 2, E'Do not challenge the machine to a staring contest—you will lose.', NULL, NULL, NULL),
(3, 5, E'The humming sound is normal. The screaming is not.', NULL, NULL, NULL),
(4, 1, E'If this equipment asks for a raise, politely decline.', NULL, NULL, NULL),
(4, 3, E'All systems nominal, except for the blinking light of mystery.', NULL, NULL, NULL),
(4, 4, E'Removed what seemed to be a nest of paperclips.', NULL, NULL, NULL),
(6, 2, E'Machine insists it\'s not broken, just differently functional.', NULL, NULL, NULL),
(6, 5, E'The machine may or may not grant wishes when turned off and on again.', NULL, NULL, NULL),
(6, 1, E'Managed to remove the sticker saying "Kick Me".', NULL, NULL, NULL),
(7, 3, E'Do not taunt the equipment. It seems to understand sarcasm.', 'public/upload_media/I-7/58a01401-a793-4fc5-8676-ecc49bda3a1a.jpg', NULL, NULL),
(7, 2, E'Found no issues except a mild attitude problem.', NULL, NULL, NULL),
(7, 2, E'Equipment demands to be addressed as "Your Highness."', NULL, NULL, NULL),
(7, 4, E'Machine is now 90% less sticky.', NULL, NULL, NULL),
(8, 5, E'Confirmed the equipment does not appreciate knock-knock jokes.', NULL, NULL, NULL),
(8, 2, E'It believes we sholuld use the Imperial system. Expect slow performance.', NULL, NULL, NULL),
(8, 1, E'If the equipment starts glowing, evacuate the building.', NULL, NULL, NULL),
(8, 1, E'Do not feed the equipment after midnight. You know the rules.', 'public/upload_media/I-8/1874937e-22fa-407b-9cc1-00ea5c51bb20.jpg', 'public/upload_media/I-8/9c1f3e5b-8276-4ea1-8298-9b796f20b7c2.jpg', NULL),
(9, 3, E'The self-destruct sequence is NOT a feature to be tested.', 'public/upload_media/F-9/3abe6ba6-0826-4c8c-acb4-fc8f00e642ec.jpg', NULL, NULL),
(9, 4, E'Found extra parts lying around, but everything seems to work.', NULL, NULL, NULL),
(9, 5, E'Removed evidence of late-night snack sessions.', NULL, NULL, NULL),
(10, 1, E'The machine is in denial about it\'s age.', 'public/upload_media/V-10/6c24e643-dc3f-4191-b195-d97853a69f44.jpg', NULL, NULL),
(10, 2, E'If the equipment starts smoking, its not on fire—its just stressed.', 'public/upload_media/V-10/38038362-9e66-40f6-b69c-90036620c634.jpg', NULL, NULL),
(10, 3, E'It responds well to compliments.', NULL, NULL, NULL),
(11, 4, E'The equipment seems to be communicating in Morse code via blinking lights.', NULL, NULL, NULL),
(11, 5, E'Discovered the source of the beeping—it was just hungry.', NULL, NULL, NULL),
(11, 1, E'Polished to a shine; can now see your reflection. Need a shave!', 'public/upload_media/F-11/2f043c7a-4a14-46ab-a67e-8a880e5f0fd0.jpg', NULL, NULL),
(12, 2, E'Machine believes it\'s a toaster.\nIt is not a toaster.', NULL, NULL, NULL),
(12, 3, E'Do not attempt to fix the machine with a hammer.\n\nAgain.', NULL, NULL, NULL),
(12, 4, E'Removed traces of glitter bomb.\nThe prank war continues.', NULL, NULL, NULL),
(12, 5, E'If found speaking to the equipment, please consult HR. Again', 'public/upload_media/I-12/027eea60-4544-408f-81d2-9dcb8c721c3f.jpg', 'public/upload_media/I-12/28090d96-0610-455e-8203-468cdcb76858.jpg', 'public/upload_media/I-12/8897c75f-2cdb-4dcf-9570-59e2f14fedf9.jpg'),
(12, 5, E'Do not mention obsolescence; it\'s a sensitive topic.', 'public/upload_media/I-12/93df09f5-9167-445d-b29a-462afa4984fd.jpg', NULL, NULL);
